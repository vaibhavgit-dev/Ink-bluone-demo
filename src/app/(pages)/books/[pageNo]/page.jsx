...
`}</style>
        ...
        <div className="mx-auto max-w-5xl px-4 py-8">
              ...
              >
                ...
                <div className="flex w-full">
                  <h3 className="text-lg font-light">
                    Categories:{" "}
                    <span className="text-[#007DD7]">{bookInfo.category}</span>
                  </h3>
                </div>
              </div>
            </div>
          ...
          <div id="about-author" className="container mx-auto text-center py-10">
            <div
      ...
      <div className="relative cursor-pointer z-[10]">
        ...
        <div id="related-titles" className="container mt-16">
          <div className="flex items-center gap-2 justify-center pb-6 pt-6">
            ...
            <h3 className="font-bold text-xl md:text-2xl text-center">Related Titles</h3>
        ...
        <div className="bg-[#FF81001A] py-6 mt-6 flex justify-center">
          <div className="container flex gap-4 justify-center items-center">
            ...
            <ul className="flex-wrap items-center space-x-6 md:flex">
              <li className="md:list-none pl-6 md:pl-0">ISBN10:{bookInfo.isbn10}</li>
              <li className="md:list-disc">ISBN13:{bookInfo.isbn13}</li>
              <li className="md:list-disc">Weight:{bookInfo.weight}</li>
              <li className="md:list-disc">Dimensions:x{bookInfo.dimension}</li>
            </ul>
            </div>
          </div>
        </div>
        ...
        <div className="fixed top-40 left-4 z-1 bg-white shadow-lg p-6 pt-10 pb-10 rounded-lg z-10 hidden lg:block">
          ...
          <ul className="flex flex-col">
            <li>
              <a href="#about-book" className="text-black hover:text-[#007BD7] pb-2">About the Book</a>
            </li>
            <li>
              <a href="#about-author" className="text-black hover:text-[#007BD7] pb-2">About the Author</a>
            </li>
            <li>
              <a href="#endorsements" className="text-black hover:text-[#007BD7] pb-2">Endorsements</a>
            </li>
            <li>
              <a href="#related-titles" className="text-black hover:text-[#007BD7] pb-2">Related Titles</a>
            </li>
          </ul>
        </div>
      </main>
