  ...
  return (
    ...
    <div class="col-lg-9 order-lg-2 pt-20 pb-20 ">
      <div className='container'>
        ...
        <h6><strong>Changes to Terms of Use:</strong></h6>
        ...
        <p>BluOne Ink grants you a limited, revocable, non-exclusive, non-transferable license to access and make personal, non-commercial use of the Sites or their Content. You may not download (other than page caching or unless otherwise allowed by BluOne Ink or permitted by law) or modify all or any portion of the Sites and their Content. This license does not include resale or commercial use of the Sites or their Content, collection and use of product listings, descriptions, or prices, derivative use of the Sites or their Content, downloading or copying of account information for the benefit of another merchant, or any use of data mining, robots, or similar data gathering and extraction tools. Unauthorized use terminates the permissions and licenses granted by BluOne Ink.</p>
        <h6><strong>Corporate Identification and Trademark:</strong></h6>
        <p>All trademarks, service marks, and trade names used herein (including but not limited to the corporate names and logos of BluOne Ink and its divisions and imprints, names and designs of the Sites, and any logos) are trademarks or registered trademarks of BluOne Ink or its affiliates, partners, vendors, or licensors. You may not use, copy, reproduce, republish, upload, post, transmit, distribute, or modify such trademarks without BluOne Ink’s express prior written consent, except for a limited, non-exclusive, non-transferable right to create a link to any page of the Sites, provided it does not portray BluOne Ink or its affiliates in a false, misleading, derogatory, or offensive manner.</p>
        <h6><strong>Links to Third-Party Websites:</strong></h6>
        <p>The site may include links to third-party Internet websites controlled and maintained by others. These links are provided solely for user convenience and do not constitute endorsement by BluOne Ink India of the linked sites or their content. BluOne Ink has no control over the content of any such sites.</p>
        <h6><strong>Fees:</strong></h6><p>For all charges for products and services sold on the Sites, BluOne Ink or its vendors will bill your credit card or alternative payment method. By providing credit card information, you represent that you are the authorized user of the card. Legal action may be taken to collect unpaid balances, and you agree to reimburse BluOne Ink for all expenses incurred.</p>
        <h6><strong>Privacy Policy:</strong></h6><p>Data collection and use, including personal information, are governed by BluOne Ink’s Privacy Policy, which is incorporated into this Agreement.</p>    </div>
    </div>
    )}
    </> 
  )
