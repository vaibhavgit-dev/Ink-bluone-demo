...
export default function Home() {
  ...
  const getAuthorsCount = (booksArray) => {
    ...
    return authors.size; // Return the size of the Set
  };
  ...
  const getLanguagesCount = (booksArray) => {
    ...
    return languages.size; // Return the size of the Set
  };
          ...
          <section className="book_by_year ">
            <i>
              <h6 className="text-center font-semibold ">
                In 2021, the year BluOne Ink was founded, we published X titles.
                <br />
      ...
      <section className="w-full items-center pt-[90px] catergory relative z-[111]  bg-[#fff]">
        ...
        <div className="flex container lg:pl-[100px] lg:pr-[100px] mt-[20px] justify-center  gap-[10px] md:gap-[60px]">
          ...
          <Image
              ...
              className=""
            />
            <Link href="/comingsoon"><div className="absolute inset-0 flex justify-center items-center">
              <span className="text-white font-medium text-lg md:text-[40px] ">FICTION</span>
            </div></Link>
          </div>
          ...
          <div className="relative overflow-hidden w-full">
            ...
            />
            <Link href="/comingsoon"><div className="absolute inset-0 flex justify-center items-center">
              <span className="text-white font-medium text-lg md:text-[40px]">NON-FICTION</span>
            </div></Link>
          </div>
          ...
          <div className="relative overflow-hidden w-full">
            ...
            />
            <Link href="/comingsoon"><div className="absolute inset-0 flex justify-center items-center">
              <span className="text-white font-medium text-lg md:text-[40px]">CHILDREN</span>
            </div>
            </Link>
          </div>
        </div>
